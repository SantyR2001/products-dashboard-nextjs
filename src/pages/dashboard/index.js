        ...
        <div className="flex flex-col">
          <div className="my-4 overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div className="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                      ...
                      <tr key={product.id}>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center">
                            ...
                            <div className="ml-4">
                              <div className="text-md font-medium text-gray-900">{product.title}</div>
                            </div>
                          </div>
                        </td>
              ...
              <Pagination offset={offset} setOffset={setOffset} productsLength={allProducts.length} />
            </div>
          </div>
          <Chart className="mt-8 mb-3" chartData={data} />
        </div>
      ) : (
        <Loading />
      )}
